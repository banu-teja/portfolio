...
<header class="fixed top-0 left-0 right-0 z-50 flex justify-center py-4 px-4 transition-all duration-300 pointer-events-none" class:py-2={isScrolled}>
	<nav
		class="pointer-events-auto flex items-center gap-2 rounded-full border border-border bg-background/80 p-1.5 backdrop-blur-md transition-all duration-300"
		class:scale-95={isScrolled}
	>
		<!-- Logo / Home Icon -->
		<a href="/" class="flex items-center justify-center rounded-full w-9 h-9 bg-primary text-primary-foreground hover:bg-zinc-200 transition-colors mr-1">
		...
		<div class="hidden sm:block border-l border-border pl-2 ml-1">
